...
const Pay = () => {
    ...
    // const [count, setCount] = useState (cart.products.filter(item =>item.id === id).map(item => (item.quantity)));
                ...
                <div className="card">
                    ...
                    <div show={show} className={`card-wrapper`}>
                        ...
                        {cart.products.map(product => (
                            <div className="card-left">
                                ...
                                <div className="card-left__one">
                                    ...
                                    <div className="img-bg"><img className="image" src={product.image} alt={product.name} /></div>

                                    <div className="card-one__text">
                                        <h4 className="cardone__subtitle">{product.name}</h4>
                                        <div className="cardleft__text">
                                            <p className="">
                                                {product.desc}
                                            </p>
                                            {/* <span className="moneySign">$</span><h4 className="">{setCount ? (amount * count): amount}</h4> */}
                                            <span className="moneySign">$</span><h4 className="">{product.price * product.quantity}</h4>
                                        </div>
                                    </div>
                        ...
                        <div className="subtotal">
                            ...
                            <h4 className=""><span className="moneySign1">$</span>{cart.total}</h4>
                        </div>
