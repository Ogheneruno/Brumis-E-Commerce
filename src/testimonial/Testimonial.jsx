...
const Testimonial = () => {
    ...
    return (
        ...
        <div className={classes.testimonialContainer}>
            ...
            <img className="testImage testImage1" src={Testimonial1} alt='#' />
            <img className="testImagex testImage2" src={Testimonial6} alt='#' />
            <img className="testImage testImage3" src={Testimonial3} alt='#' />
            <img className="testImagex testImage4" src={Testimonial4} alt='#' />
            <img className="testImageL testImage5" src={Testimonial5} alt='#' />
            <img className="testImageL testImage6" src={Testimonial2} alt='#' />
